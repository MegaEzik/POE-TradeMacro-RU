...
AdpRu_ItemDataEnToRu(idft) {
	...
	For k, val in lidft {
		...
		;Если что-то не сконвертировалось, то заменим на пустую строку.
	...
	;Уведомление о не сконвертированных строках
	if(idtferl!="") {
		idtferl:="Не удалось сконвертировать следующие строки, они были заменены пустыми и не будут учтены при прогнозе:`n`n" idtferl
		MsgBox, 0x1030, Внимание!, %idtferl%
	}
	
	;Вывод информации для отладки
	FormatTime, stime
	FileAppend, `n==============================%stime%==============================`n%bidtf%, temp\PredictedPricingData.txt
	sleep 100
	FileAppend, `n=============================`n%idtfen%, temp\PredictedPricingData.txt
	console.log(idtfen)
